...
def reproduce():
    ...
    p = Property(address="123 Test St", fee_amount=50.0)
    c.properties = [p]
    ...
    kwargs = {
        "fee_2_type": "Late Fee",
        "fee_2_amount": 50.0,
        "fee_3_type": "Late Fee", # User might have selected Late Fee again?
        "fee_3_amount": 75.0,
    ...
    if found_fee_3:
        print("\n✅ Fee 3 ($75.00) FOUND in output.")
    else:
        print("\n❌ Fee 3 ($75.00) MISSING from output.")
